...
A standalone FiveM loading screen for Los Santos Nights styled after the supplied reference: a cinematic full-screen FiveMManage background blended into a pink overlay, bold left-side editorial panels, right-side community links, a centered rotating PNG logo, bottom video controls, bottom connection progress, and configurable owner/admin branding.
